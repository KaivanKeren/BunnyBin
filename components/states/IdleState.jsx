...
export default function IdleState({ onInsert }) {
  return (
    <motion.div
      key="idle"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center">
        <Bunny mood="idle" size={210} waving />
      </div>
      ...
      >
        Halo Teman!{" "}
        <span className="text-organic-500">Ayo Masukkan</span>{" "}
        <span className="text-inorganic-500">Sampah!</span>
      </motion.h1>

      {/* Hand-inserting-trash hint */}
      <motion.div
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
