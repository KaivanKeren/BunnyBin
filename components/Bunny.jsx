...
// Bunny mascot - SVG illustration. `mood` controls facial expression.
// moods: idle | scan | think | happy | sad
export default function Bunny({ mood = "idle", size = 260, waving = false }) {
  const eyes = {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Nose */}
        <path
          d="M126 138 q4 -4 8 0 q-4 6 -8 0z"
          fill="#F4A1A1"
        />
